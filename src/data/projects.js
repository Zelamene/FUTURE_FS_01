...
const projectsData = [
  {
    ...
    description:
      "Independently analysed seven years of JSE Top 40 and USD/ZAR data to test the rand-hedge thesis. Found that the effect is episodic — near-zero on average but stark during crises, with a 36-point return gap between Naspers and Standard Bank in March 2020. Includes a live Streamlit dashboard and a trading strategy backtest.",
