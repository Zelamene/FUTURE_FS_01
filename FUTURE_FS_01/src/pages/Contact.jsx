        ...
        <div className="min-h-[calc(100vh-140px)] max-w-[1100px] mx-auto px-4 md:px-8 py-12 md:py-20 mt-16 grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <p className="text-[18px] text-[#6B7280] dark:text-[#D1D5DB] mb-8">
                    Have a question or want to work together? Leave a message here or reach out through my socials.
                </p>
            ...
            <div className="bg-[#FFFFFF] dark:bg-[#111827] p-6 md:p-8 rounded-[12px] border border-[#E5E7EB] dark:border-[#1F2937] shadow-sm">
                {isSuccess ? (
                    ...
                    >
                        ...
                        <div>
                            <label htmlFor="name" className="block text-sm font-medium text-[#111827] dark:text-[#F9FAFB] mb-1.5">
                                Name <span className="text-[#DC2626] dark:text-[#EF4444]">*</span>
                            </label>
                            <input
                                type="text"
                                id="name"
                        ...
                        <div>
                            <label htmlFor="email" className="block text-sm font-medium text-[#111827] dark:text-[#F9FAFB] mb-1.5">
                                Email <span className="text-[#DC2626] dark:text-[#EF4444]">*</span>
                            </label>
                            <input
                                type="email"
                                id="email"
                        ...
                        <div>
                            <label htmlFor="subject" className="block text-sm font-medium text-[#111827] dark:text-[#F9FAFB] mb-1.5">
                                Subject
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label htmlFor="message" className="block text-sm font-medium text-[#111827] dark:text-[#F9FAFB] mb-1.5">
                                Message <span className="text-[#DC2626] dark:text-[#EF4444]">*</span>
                            </label>
                            <textarea
                                id="message"
                                name="message"
